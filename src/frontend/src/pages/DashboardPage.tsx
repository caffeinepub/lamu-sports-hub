...
export function DashboardPage({
  ...
  return (
    <div data-ocid="dashboard.page" className="min-h-screen pb-24 pt-14">
      ...
      {/* Data-is-local warning banner for simple/PIN users */}
      {currentSimpleUser && !isAdmin && (
        <div
          className="flex items-center gap-2 px-4 py-2"
          style={{
            background: "oklch(0.35 0.08 50 / 0.9)",
            borderBottom: "1px solid oklch(0.5 0.12 50 / 0.4)",
          }}
          data-ocid="dashboard.local_data_warning"
        >
